...
wwwDir = options.html_path 
livvDir = wwwDir + 'livv'
nclDir = options.ncl_path


# remove www/livv directory if it exists
if os.path.isdir(livvDir):
    shutil.rmtree(livvDir)
...
if (os.path.exists(nclDir + '/alaska_pic.png')):
        shutil.copy(nclDir + '/alaska_pic.png', livvDir + '/')
...
if options.test_suite and options.glam_flag:
    ...
    test_file = open(livvDir + '/test_suite.html', 'w')
    descript_file = open(livvDir + '/test_descript.html', 'w')

    # diagnostic dome case
    dome30d_file = open(livvDir + '/dome30d_details.html', 'w')
    dome30d_case = open(livvDir + '/dome30d_case.html', 'w')
    dome30d_plot = open(livvDir + '/dome30d_plot.html', 'w')
    
    # evolving dome case
    dome30e_file = open(livvDir + '/dome30e_details.html', 'w')
    dome30e_case = open(livvDir + '/dome30e_case.html', 'w')
    dome30e_plot = open(livvDir + '/dome30e_plot.html', 'w')

    # circular shelf case
    circ_file = open(livvDir + '/circ_details.html', 'w')
    circ_case = open(livvDir + '/circ_case.html', 'w')
    circ_plot = open(livvDir + '/circ_plot.html', 'w')

    # confined shelf case
    conf_file = open(livvDir + '/conf_details.html', 'w')
    conf_case = open(livvDir + '/conf_case.html', 'w')
    conf_plot = open(livvDir + '/conf_plot.html', 'w')

    # ismip hom a 80km case
    ishoma80_file = open(livvDir + '/ishoma80_details.html', 'w')
    ishoma80_case = open(livvDir + '/ishoma80_case.html', 'w')
    ishoma80_plot = open(livvDir + '/ishoma80_plot.html', 'w')
    
    # ismip hom a 20km case
    ishoma20_file = open(livvDir + '/ishoma20_details.html', 'w')
    ishoma20_case = open(livvDir + '/ishoma20_case.html', 'w')
    ishoma20_plot = open(livvDir + '/ishoma20_plot.html', 'w')
    
    # ismip hom c 80km case
    ishomc80_file = open(livvDir + '/ishomc80_details.html', 'w')
    ishomc80_case = open(livvDir + '/ishomc80_case.html', 'w')
    ishomc80_plot = open(livvDir + '/ishomc80_plot.html', 'w')
    
    # ismip hom c 20km case
    ishomc20_file = open(livvDir + '/ishomc20_details.html', 'w')
    ishomc20_case = open(livvDir + '/ishomc20_case.html', 'w')
    ishomc20_plot = open(livvDir + '/ishomc20_plot.html', 'w')
    ...
    VV_testsuite.web(glam_flag, descript_file, test_file, dome30d_file, dome30d_case, dome30d_plot, \
        ...
        reg_test, options.test_suite, options.data_dir, options.ncl_path, livvDir, options.script_path, \
...
if options.test_suite:
        glam_flag = 0
        test_file_glissade = open(livvDir + '/test_suite_glissade.html', 'w')
        descript_file_glissade = open(livvDir + '/test_descript.html', 'w')

        # diagnostic dome case
        dome30d_file_glissade = open(livvDir + '/dome30d_details_glissade.html', 'w')
        dome30d_case_glissade = open(livvDir + '/dome30d_case_glissade.html', 'w')
        dome30d_plot_glissade = open(livvDir + '/dome30d_plot_glissade.html', 'w')
        
        # evolving dome case
        dome30e_file_glissade = open(livvDir + '/dome30e_details_glissade.html', 'w')
        dome30e_case_glissade = open(livvDir + '/dome30e_case_glissade.html', 'w')
        dome30e_plot_glissade = open(livvDir + '/dome30e_plot_glissade.html', 'w')
        
        # circular shelf case
        circ_file_glissade = open(livvDir + '/circ_details_glissade.html', 'w')
        circ_case_glissade = open(livvDir + '/circ_case_glissade.html', 'w')
        circ_plot_glissade = open(livvDir + '/circ_plot_glissade.html', 'w')
        
        # confined shelf case
        conf_file_glissade = open(livvDir + '/conf_details_glissade.html', 'w')
        conf_case_glissade = open(livvDir + '/conf_case_glissade.html', 'w')
        conf_plot_glissade = open(livvDir + '/conf_plot_glissade.html', 'w')
        
        # ismip hom a 80km case
        ishoma80_file_glissade = open(livvDir + '/ishoma80_details_glissade.html', 'w')
        ishoma80_case_glissade = open(livvDir + '/ishoma80_case_glissade.html', 'w')
        ishoma80_plot_glissade = open(livvDir + '/ishoma80_plot_glissade.html', 'w')

        # ismip hom a 20km case
        ishoma20_file_glissade = open(livvDir + '/ishoma20_details_glissade.html', 'w')
        ishoma20_case_glissade = open(livvDir + '/ishoma20_case_glissade.html', 'w')
        ishoma20_plot_glissade = open(livvDir + '/ishoma20_plot_glissade.html', 'w')
        
        # ismip hom c 80km case
        ishomc80_file_glissade = open(livvDir + '/ishomc80_details_glissade.html', 'w')
        ishomc80_case_glissade = open(livvDir + '/ishomc80_case_glissade.html', 'w')
        ishomc80_plot_glissade = open(livvDir + '/ishomc80_plot_glissade.html', 'w')

        # ismip hom c 20km case
        ishomc20_file_glissade = open(livvDir + '/ishomc20_details_glissade.html', 'w')
        ishomc20_case_glissade = open(livvDir + '/ishomc20_case_glissade.html', 'w')
        ishomc20_plot_glissade = open(livvDir + '/ishomc20_plot_glissade.html', 'w')
        
        # path to python code to create all the test suite pages and data
        reg_test = options.test_suite + "/reg_test"

        VV_testsuite.web(glam_flag, descript_file_glissade, test_file_glissade, \
                        dome30d_file_glissade, dome30d_case_glissade, dome30d_plot_glissade, \
                        dome30e_file_glissade, dome30e_case_glissade, dome30e_plot_glissade, \
                        circ_file_glissade, circ_case_glissade, circ_plot_glissade, \
                        conf_file_glissade, conf_case_glissade, conf_plot_glissade, \
                        ishoma80_file_glissade, ishoma80_case_glissade, ishoma80_plot_glissade, \
                        ishoma20_file_glissade, ishoma20_case_glissade, ishoma20_plot_glissade, \
                        ishomc80_file_glissade, ishomc80_case_glissade, ishomc80_plot_glissade, \
                        ishomc20_file_glissade, ishomc20_case_glissade, ishomc20_plot_glissade, \
                        reg_test, options.test_suite, options.data_dir, options.ncl_path, \
                        livvDir, options.script_path, options.diagnostic_flag, options.evolving_flag, \
                        options.circular_flag, options.confined_flag, options.ismip_hom_a80_flag, \
                        options.ismip_hom_a20_flag, options.ismip_hom_c80_flag, options.ismip_hom_c20_flag)
...
if options.dome60_flag == 1 or options.dome120_flag == 1 or options.dome240_flag == 1 or options.dome500_flag == 1 \
        ...
        large_test_file = open(livvDir + '/large_test_suite.html', 'w')
        descript_file = open(livvDir + '/large_test_descript.html', 'w')

        # dome60 case
        dome60_file = open(livvDir + '/dome60_details.html', 'w')
        dome60_case = open(livvDir + '/dome60_case.html', 'w')
        dome60_time = open(livvDir + '/dome60_timing.html', 'w')
        dome60_plot = open(livvDir + '/dome60_plot.html', 'w')

        # dome120 case
        dome120_file = open(livvDir + '/dome120_details.html', 'w')
        dome120_case = open(livvDir + '/dome120_case.html', 'w')
        dome120_time = open(livvDir + '/dome120_timing.html', 'w')
        dome120_plot = open(livvDir + '/dome120_plot.html', 'w')
        
        # dome240 case
        dome240_file = open(livvDir + '/dome240_details.html', 'w')
        dome240_case = open(livvDir + '/dome240_case.html', 'w')
        dome240_time = open(livvDir + '/dome240_timing.html', 'w')
        dome240_plot = open(livvDir + '/dome240_plot.html', 'w')
        
        # dome500 case
        dome500_file = open(livvDir + '/dome500_details.html', 'w')
        dome500_case = open(livvDir + '/dome500_case.html', 'w')
        dome500_time = open(livvDir + '/dome500_timing.html', 'w')
        dome500_plot = open(livvDir + '/dome500_plot.html', 'w')
        
        # dome1000 case
        dome1000_file = open(livvDir + '/dome1000_details.html', 'w')
        dome1000_case = open(livvDir + '/dome1000_case.html', 'w')
        dome1000_time = open(livvDir + '/dome1000_timing.html', 'w')
        dome1000_plot = open(livvDir + '/dome1000_plot.html', 'w')
        
        # gis 1km case
        gis1km_file = open(livvDir + '/gis1km_details.html', 'w')
        gis1km_case = open(livvDir + '/gis1km_case.html', 'w')
        gis1km_time = open(livvDir + '/gis1km_timing.html', 'w')
        gis1km_plot = open(livvDir + '/gis1km_plot.html', 'w')
        
        # gis 2km case
        gis2km_file = open(livvDir + '/gis2km_details.html', 'w')
        gis2km_case = open(livvDir + '/gis2km_case.html', 'w')
        gis2km_time = open(livvDir + '/gis2km_timing.html', 'w')
        gis2km_plot = open(livvDir + '/gis2km_plot.html', 'w')
        
        # gis 4km case
        gis4km_file = open(livvDir + '/gis4km_details.html', 'w')
        gis4km_case = open(livvDir + '/gis4km_case.html', 'w')
        gis4km_time = open(livvDir + '/gis4km_timing.html', 'w')
        gis4km_plot = open(livvDir + '/gis4km_plot.html', 'w')

        # path to python code to create all the large test suite pages and data
        perf_test = options.test_suite + "/perf_test"

        VV_largesuite.large_tests(descript_file, large_test_file, \
                dome60_file, dome60_case, dome60_time, dome60_plot, \
                dome120_file, dome120_case, dome120_time, dome120_plot, \
                dome240_file, dome240_case, dome240_time, dome240_plot, \
                dome500_file, dome500_case, dome500_time, dome500_plot, \
                dome1000_file, dome1000_case, dome1000_time, dome1000_plot, \
                ...
                perf_test, options.ncl_path, livvDir, options.script_path, \
        ...
        dictionary_large = VV_largesuite.time_check(perf_test, options.dome60_flag, \
                options.dome120_flag, options.dome240_flag, options.dome500_flag, \
                options.dome1000_flag, options.gis_1km_flag, options.gis_2km_flag, \
                options.gis_4km_flag)

# create all the validation plot pages
# print options.validation_flag 
if options.validation_flag == 1:
        valid_file_cism = open(livvDir + '/validation_cism.html', 'w')
        details_file = open(livvDir + 'case_details.html', 'w')
        
# If necessary run the coupled tests
if options.val_coupled_flag != 0:
        valid_file_cam = open(livvDir + '/validation_cam.html', 'w')
        valid_file_clm = open(livvDir + '/validation_clm.html', 'w')
        table = open(livvDir + '/table.html', 'w')
        figure1_plot = open(livvDir + '/figure1_plot.html', 'w')
        figure2_plot = open(livvDir + '/figure2_plot.html', 'w')
        figure3_plot = open(livvDir + '/figure3_plot.html', 'w')
        figure4_plot = open(livvDir + '/figure4_plot.html', 'w')
        figure5_plot = open(livvDir + '/figure5_plot.html', 'w')

        # path to python code to create all the test suite pages and data
        VV_validation_suite.web(valid_file_cism, valid_file_cam, valid_file_clm, details_file, table, \
                figure1_plot, figure2_plot, figure3_plot, figure4_plot, figure5_plot, \
                options.data_dir, options.ncl_path, livvDir, options.script_path)


# writing the main HTML page
file = open(livvDir + '/livv_kit_main.html', 'w')
