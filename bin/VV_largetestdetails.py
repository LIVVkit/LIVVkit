...
# Failure checking
    ...
    procttl_dd304, nonlist_dd304,avg2_dd304,out_flag_dd304,ndd304_name,ldd304_name = \
        VV_outprocess.jobprocess(perf_test + '/dome60/' + data_dir + '/out.60.PIC','domed304')
    ...
    procttl_dd304b, nonlist_dd304b,avg2_dd304b,out_flag_dd304b,ndd304b_name,ldd304b_name = \
        VV_outprocess.jobprocess(perf_test + '/bench/dome60/' + data_dir + '/out.60.PIC','domed304b')
...
# Failure checking
    ...
    procttl_dd304, nonlist_dd304,avg2_dd304,out_flag_dd304,ndd304_name,ldd304_name = \
        VV_outprocess.jobprocess(perf_test + '/dome120/' + data_dir + '/out.120.PIC','domed304')
    ...
    procttl_dd304b, nonlist_dd304b,avg2_dd304b,out_flag_dd304b,ndd304b_name,ldd304b_name = \
        VV_outprocess.jobprocess(perf_test + '/bench/dome120/' + data_dir + '/out.120.PIC','domed304b')
...
# Failure checking
    ...
    procttl_dd304, nonlist_dd304,avg2_dd304,out_flag_dd304,ndd304_name,ldd304_name = \
        VV_outprocess.jobprocess(perf_test + '/dome240/' + data_dir + '/out.240.PIC','domed304')
    ...
    procttl_dd304b, nonlist_dd304b,avg2_dd304b,out_flag_dd304b,ndd304b_name,ldd304b_name = \
        VV_outprocess.jobprocess(perf_test + '/bench/dome240/' + data_dir + '/out.240.PIC','domed304b')
...
# Failure checking
    ...
    procttl_dd304, nonlist_dd304,avg2_dd304,out_flag_dd304,ndd304_name,ldd304_name = \
        VV_outprocess.jobprocess(perf_test + '/dome500/' + data_dir + '/out.500.PIC','domed304')
    ...
    procttl_dd304b, nonlist_dd304b,avg2_dd304b,out_flag_dd304b,ndd304b_name,ldd304b_name = \
        VV_outprocess.jobprocess(perf_test + '/bench/dome500/' + data_dir + '/out.500.PIC','domed304b')
...
# Failure checking
    ...
    procttl_dd304, nonlist_dd304,avg2_dd304,out_flag_dd304,ndd304_name,ldd304_name = \
        VV_outprocess.jobprocess(perf_test + '/dome1000/' + data_dir + '/out.1000.PIC','domed304')
    ...
    procttl_dd304b, nonlist_dd304b,avg2_dd304b,out_flag_dd304b,ndd304b_name,ldd304b_name = \
        VV_outprocess.jobprocess(perf_test + '/bench/dome1000/' + data_dir + '/out.1000.PIC','domed304b')
