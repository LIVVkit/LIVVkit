...
#Glimmer stats
	#if dictionary['glimmer'] == 0:
		#test_file.write('<H2>Glimmer Test: <font color="green">Bit-for-Bit</font></H2>')
	#else:
        #test_file.write('<BR>\n')
        #test_file.write('<BR>\n')
	#test_file.write('<H2>Glimmer Test: <font color="red">Not Bit-for-Bit</font></H2>')
...
#	descript_file = open(options.html_path + '/test_descript.html', 'w')
	...
	descript_file.write('  What does it test? \n')
	descript_file.write('<BR><BR>\n')
	descript_file.write('The Glimmer test case \n')
	descript_file.write('<BR>\n')
	descript_file.write("Glimmer is structured on a modular basis, with the modeled processes divided into discrete units. The core thermomechanical ice model, a climate driver, a mass balance fields, and a geothermal model.")
	descript_file.write('<BR><BR>\n')
	descript_file.write('</HTML>\n')
	descript_file.close()
