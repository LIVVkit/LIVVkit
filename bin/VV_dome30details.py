...
def ddetails(solver_file,job_path,ncl_path,data_path,target_html,bench_data):  # using data, fill the web page with info
...
# failure checkin
	...
	procttl_dd301b, nonlist_dd301b,avg2_dd301b,out_flag_dd301b,ndd301b_name,ldd301b_name = VV_outprocess.jobprocess(job_path + '/bench/dome30/diagnostic/' + bench_data + '/gnu.JFNK.1proc', 'domed301b')
...
# Failure checking
	...
	procttl_dd304b, nonlist_dd304b,avg2_dd304b,out_flag_dd304b,ndd304b_name,ldd304b_name = VV_outprocess.jobprocess(job_path + '/bench/dome30/diagnostic/' + bench_data + '/gnu.JFNK.4proc','domed304b')
...
def edetails(solver_file,job_path,ncl_path,data_path,target_html,bench_data):  # using data, fill the web page with info
...
#	print job_path + '/dome30/evolving/data/gnu.JFNK.1proc'
	...
	procttl_de309b, nonlist_de309b,avg2_de309b,out_flag_de309b,nde309b_name,lde309b_name = VV_outprocess.jobprocess(job_path + '/bench/dome30/evolving/' + bench_data + '/gnu.JFNK.9proc', 'domee309b')
...
# Failure checking
	...
	procttl_de3015b, nonlist_de3015b,avg2_de3015b,out_flag_de3015b,nde3015b_name,lde3015b_name = VV_outprocess.jobprocess(job_path + '/bench/dome30/evolving/' + bench_data + '/gnu.JFNK.15proc', 'domee3015b')
...
def dplot(plot_file,job_path,ncl_path,html_path,script_path,bench_data):  # using data, fill the web page with info
...
# creating dome 30d velocity plot
	...
	stockout='STOCKout = addfile(\"'+ job_path + '/bench/dome30/diagnostic/' + bench_data + '/dome.out.nc\", \"r\")'
	stock1='STOCK1 = addfile(\"'+ job_path + '/bench/dome30/diagnostic/' + bench_data + '/dome.1.nc\", \"r\")'
	stock4='STOCK4 = addfile(\"'+ job_path + '/bench/dome30/diagnostic/' + bench_data + '/dome.4.nc\", \"r\")'
...
def eplot(plot_file,job_path,ncl_path,html_path,script_path,bench_data):  # using data, fill the web page with info
...
# creating dome 30e velocity plot
	...
	stock9='STOCK9 = addfile(\"'+ job_path + '/bench/dome30/evolving/' + bench_data + '/dome.9.nc\", \"r\")'
	stock15='STOCK15 = addfile(\"'+ job_path + '/bench/dome30/evolving/' + bench_data + '/dome.15.nc\", \"r\")'
