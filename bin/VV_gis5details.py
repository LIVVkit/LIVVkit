...
# Failure checking
        ...
        procttl_gis5d, nonlist_gis5d, avg2_gis5d, out_flag_gis5d, ndg102_name, ldg102_name = VV_outprocess.jobprocess(perf_test + '/gis_5km/data/out.gnu','gis5km')

        procttl_gis5b, nonlist_gis5b, avg2_gis5b, out_flag_gis5b, ndg102b_name, ldg102b_name = VV_outprocess.jobprocess(perf_test + '/bench/gis_5km/'+ bench_data + '/out.gnu','gis5kmb')
